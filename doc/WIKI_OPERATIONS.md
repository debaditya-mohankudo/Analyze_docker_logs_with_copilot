...
See **[WIKI_COPILOT_PROMPTS.md](WIKI_COPILOT_PROMPTS.md)** — full prompt library organized by workflow (triage, spike, correlation, root cause, secrets, capture, and combined investigations).
